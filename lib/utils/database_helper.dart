...
// open the database
  ...
  Future<List<Kategori>> kategoriListesiniGetir()async{
    var kategoriMap = await kategorileriGetir();
    var kategoriListesi = List<Kategori>();
    for(Map map in kategoriMap){
  ...
  Future<List<Notlar>> notListesi() async{
    var notlarMap = await notGetir();
    var notListesi=List<Notlar>();
    for(Map map in notlarMap){
